...
{
    green "正在安装/更新V2Ray。。。。"
    if ! bash <(curl -L https://raw.githubusercontent.com/rivernofish/install_v2ray/main/v4.32.1.sh) && ! bash <(curl -L https://raw.githubusercontent.com/rivernofish/install_v2ray/main/v4.32.1.sh); then
        red    "安装/更新V2Ray失败"
        yellow "按回车键继续或者按ctrl+c终止"
        read -s
        return 1
